...
<tr>
  ...
  <td style="padding: 8px; border: 1px solid #ddd;">
    🏁 5% of your payment (${booking.currency} ${(
               booking.total * 0.05
...
`
        ...
        <tr style="background-color: #e6f0fa;">
          ...
          <td style="padding: 8px; border: 1px solid #ddd;">${
            booking.currency
          } ${booking.total.toLocaleString("id-ID")}</td>
        </tr>
      </table>
      ...
      <table style="width: 100%; border-collapse: collapse; margin: 20px 0; font-size: 14px; background-color: #fff; border-radius: 4px;">
        <tr style="background-color: #e6f0fa;">
          ...
          <td style="padding: 8px; border: 1px solid #ddd;">${
            booking.currency
          } ${booking.amountPaid.toLocaleString("id-ID")}</td>
        </tr>
        ${
        ...
        <tr>
          ...
          <td style="padding: 8px; border: 1px solid #ddd;">${
            booking.currency
          } ${booking.remainingAmount.toLocaleString("id-ID")}</td>
        </tr>
        <tr style="background-color: #e6f0fa;">
      ...
      <p style="font-size: 16px; line-height: 1.5;">${
        booking.airportTransfer ? "Free airport transfer included! " : ""
      }Need assistance with ${
  booking.airportTransfer ? "other " : ""
}arrangements? Reply to this email.</p>
  ...
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; border-radius: 8px; color: #333;">
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 20px 0; font-size: 14px;">
      ...
      <tr>
        ...
        <td style="padding: 8px; border: 1px solid #ddd;">${
          booking.currency
        } ${booking.amountPaid.toLocaleString("id-ID")} (${
...
const getSecondPaymentReminderTemplate = ({
  booking,
  checkInFormatted,
  finalPaymentDue,
  bookingIdFormatted,
...
const getSecondPaymentConfirmationTemplate = ({
  booking,
  checkInFormatted,
  bookingIdFormatted,
}) => `
...
const getPreArrivalEmailTemplate = ({
  booking,
  checkInFormatted,
  checkOutFormatted,
  bookingIdFormatted,
